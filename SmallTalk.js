...
question("are you good or (bad|evil)", reply("I'm good"));
...
//response when user requests by typing
projectAPI.handleText = function (p, param, callback) {
  switch (param.content) {
    case "Hello":
      ...
      break;
    case "I am happy":
      p.play(`Sure, I'm always with you`);
      break;
    case "What is your name?":
      p.play("My name is Alan");
      break;
    case "Today is my birthday":
      p.play("Happy birthday to you");
      break;
